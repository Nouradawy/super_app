          ...
          child: SizedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 40,),
                  Text("Create Your Account" ,style:GoogleFonts.manrope(fontSize: 25, fontWeight: FontWeight.w900 , color:HexColor("#111418")),),
                  SizedBox(height: 5,),
                  ...
                  Container(
                    ...
                    child: MaterialButton(
                      ...
                      child:SizedBox(
                          width: double.infinity,
                          height: 45,
                          child: Center(child: Text("Sign Up" ,style:GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w700 , color:Colors.black),))),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text("Already have an account?" ,style:GoogleFonts.manrope(fontSize: 12, fontWeight: FontWeight.w500 , color:HexColor("#637488")),),
                      Text("Sign in" ,style:GoogleFonts.manrope(fontSize: 12, fontWeight: FontWeight.w500 , color:HexColor("#637488")),),
                    ],
                  ),
                ],
              ),
